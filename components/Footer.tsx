...
const Footer = () => {
    return (
        <div className={'relative bg-[#285f58]'}>
            ...
            <div className={'flex gap-32 justify-center items-center pb-10 mx-32 border-b border-white'}>
                ...
                <div className={'flex items-center justify-center pt-20'}>
                    <div className={'h-10 mt-12 w-48 flex items-center justify-center p-2 bg-[#e8512a] shadow-md shadow-orange-800 hover:bg-white hover:text-[#e8512a] hover:font-bold transform duration-300 cursor-pointer text-white font-thin text-sm rounded-bl-xl rounded-tr-xl rounded-tl-sm rounded-br-sm'}>
                        Make an reservation
                    </div>
                </div>
            </div>
